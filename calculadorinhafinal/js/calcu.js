document.addEventListener("DOMContentLoaded", function () {
    // Carrega as unidades consumidoras e bandeiras
...
function calcularConsumo() {
    ...
    // Busca dispositivos por unidade consumidora
    fetch(`http://localhost:8000/unidades-consumidoras/${unidadeId}/dispositivos`)
        ...
        .then(data => {
            ...
            // Calcula o consumo total baseado nos dispositivos
            data.dispositivos.forEach(dispositivo => {
                consumoTotal += dispositivo.consumo_diario * dispositivo.quantidade;
            });

            const consumoAnual = consumoTotal * 365; // Exemplo de cálculo anual
            const custoTotal = consumoAnual * bandeiraTarifa; // Aplica tarifa
